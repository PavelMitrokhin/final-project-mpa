...
public class LoginFormXpath {
    ...
    public static final String BUTTON_CONTINUE_REGISTER_XPATH = "//button[@class='forget-password-link']";
    ...
    public static final String CODE_IS_SENT_TITLE_XPATH = "//div[@class='error']";
    public static final String SMS_HELP_TITLE_XPATH = "//div[@class='error']";
    public static final String LOGIN_TITLE_XPATH = "//div[@class='error']";
